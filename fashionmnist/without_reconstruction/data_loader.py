...
def get_loaders_cifar100(train_translation_rotation_list,test_translation_rotation_list,batch_size):
    ...
    for (translation,rotation) in train_translation_rotation_list:
        train_desc = 'train_'+str(translation[0])+'_'+str(translation[1])+'_'+str(rotation)+'_'+'FashionMNIST'#for identifying in logs 
    ...
    for (translation,rotation) in test_translation_rotation_list:
        test_desc = 'test_'+str(translation[0])+'_'+str(translation[1])+'_'+str(rotation)+'_'+'FashionMNIST'#for identifying in logs  
